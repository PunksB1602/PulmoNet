...
class GradCAM:
    def __init__(self, model, target_layer):
        ...
        # Capture activations and gradients at `target_layer` for Grad-CAM.
...
if __name__ == "__main__":
    ...
    # Disable in-place ops in DenseNet to avoid backward-hook runtime errors.
    for m in model.modules():
        if hasattr(m, 'inplace'):
            m.inplace = False

    # Use a conv in the last dense block to get stable feature maps for CAM.
    ...
    print(f"Saving DenseNet Heatmaps to outputs/{model_name}/...")
