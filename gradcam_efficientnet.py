...
class GradCAM:
    def __init__(self, model, target_layer):
        ...
        # Register hooks to capture activations and gradients at the chosen layer.
        # These are combined to form the Grad-CAM heatmap for a class.
...
if __name__ == "__main__":
    ...
    # EfficientNet stores final conv features in `features`; use the last block.
    ...
    # Outputs are simple overlay images written to outputs/<model>/gradcam_<label>.jpg
    print(f"Saving EfficientNet Heatmaps to outputs/{model_name}/...")
